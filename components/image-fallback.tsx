/**
 * @fileoverview UI组件 · image-fallback.tsx
            ...
            <svg width="60" height="60" viewBox="0 0 60 60" className="mx-auto mb-2">
              <defs>
                <linearGradient id="newbieGrad" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor={cWhite} opacity="0.9" />
                  <stop offset="100%" stopColor={cWhite} opacity="0.7" />
                </linearGradient>
              </defs>
              <rect x="15" y="20" width="30" height="25" rx="2" fill="url(#newbieGrad)" />
              <rect x="18" y="23" width="24" height="2" fill={cWhite80} />
              <rect x="18" y="27" width="20" height="2" fill={cWhite80} />
              <rect x="18" y="31" width="22" height="2" fill={cWhite80} />
              <rect x="18" y="35" width="18" height="2" fill={cWhite80} />
