...
function SidebarFooter({ className, ref, ...props }: React.ComponentProps<"div">) {
  return <div ref={ref} data-slot="sidebar-footer" data-sidebar="footer" className={cn("flex flex-col gap-2 p-2", className)} {...props} />
}
...
function SidebarGroupLabel({ className, asChild = false, ref, ...props }: React.ComponentProps<"div"> & { asChild?: boolean }) {
...
function SidebarGroupAction({ className, asChild = false, ref, ...props }: React.ComponentProps<"button"> & { asChild?: boolean }) {
...
function SidebarMenuAction({ className, asChild = false, showOnHover = false, ref, ...props }: React.ComponentProps<"button"> & { asChild?: boolean; showOnHover?: boolean }) {
  const Comp = asChild ? Slot : "button"
  return (
    <Comp
      ref={ref}
...
function SidebarMenuSkeleton({ className, showIcon = false, ref, ...props }: React.ComponentProps<"div"> & { showIcon?: boolean }) {
  const width = React.useMemo(() => `${Math.floor(Math.random() * 40) + 50}%`, [])
  return (
    <div ref={ref} data-slot="sidebar-menu-skeleton" data-sidebar="menu-skeleton" className={cn("rounded-md h-8 flex gap-2 px-2 items-center", className)} {...props}>
