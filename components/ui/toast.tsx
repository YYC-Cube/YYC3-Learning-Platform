...
function ToastViewport({ className, ref, ...props }: React.ComponentProps<typeof ToastPrimitives.Viewport>) {
  return <ToastPrimitives.Viewport ref={ref} data-slot="toast-viewport" className={cn("fixed top-0 z-[100] flex max-h-screen w-full flex-col-reverse p-4 sm:bottom-0 sm:right-0 sm:top-auto sm:flex-col md:max-w-[420px]", className)} {...props} />
}
...
function ToastTitle({ className, ref, ...props }: React.ComponentProps<typeof ToastPrimitives.Title>) {
  return <ToastPrimitives.Title ref={ref} data-slot="toast-title" className={cn("text-sm font-semibold", className)} {...props} />
}

function ToastDescription({ className, ref, ...props }: React.ComponentProps<typeof ToastPrimitives.Description>) {
  return <ToastPrimitives.Description ref={ref} data-slot="toast-description" className={cn("text-sm opacity-90", className)} {...props} />
}
