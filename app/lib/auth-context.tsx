...
interface LoginResponse {
  success: boolean
  token?: string
  user?: Partial<User> & { id: string | number; email: string; display_name?: string; role?: string }
  error?: string
}
...
function createFallbackUser(email: string): User {
  return {
    ...
    learningStats: { totalCourses: 0, completedCourses: 0, totalHours: 0, currentStreak: 0, longestStreak: 0, averageScore: 0 },
    enrolledCourses: [],
    achievements: [],
    preferences: { language: "zh-CN", timezone: "Asia/Shanghai", emailNotifications: true, pushNotifications: true, weeklyReport: true, theme: "system", learningReminder: { enabled: false, time: "09:00", days: [] }, notifications: true, emailUpdates: true },
    progress: {},
  }
}
...
function mapApiUserToUser(apiUser: LoginResponse["user"], email: string): User {
  ...
  return {
    ...
    learningStats: apiUser.learningStats || { totalCourses: 0, completedCourses: 0, totalHours: 0, currentStreak: 0, longestStreak: 0, averageScore: 0 },
    enrolledCourses: apiUser.enrolledCourses || [],
    achievements: apiUser.achievements || [],
    preferences: apiUser.preferences || { language: "zh-CN", timezone: "Asia/Shanghai", emailNotifications: true, pushNotifications: true, weeklyReport: true, theme: "system", learningReminder: { enabled: false, time: "09:00", days: [] }, notifications: true, emailUpdates: true },
